          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-6">
                ...
                {/* Secondary link */}
                <a href="#" className="group relative inline-flex items-center px-4 py-2 hover:bg-purple-50/50 rounded-lg transition-all duration-300 transform hover:scale-102">
                  {/* Play icon with subtle animation */}
                  <div className="relative mr-2 w-6 h-6 bg-gradient-to-br from-purple-500/80 to-indigo-600/80 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-105">
                    <svg className="w-2.5 h-2.5 text-white ml-0.5 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M8 5v14l11-7z"/>
                    </svg>
                  </div>
                  
                  <span className="text-purple-600 font-medium group-hover:text-purple-700 transition-colors duration-300">Watch Demo</span>
                  
                  {/* Subtle arrow */}
                  <svg className="w-3 h-3 ml-1 text-purple-500 transform group-hover:translate-x-0.5 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
