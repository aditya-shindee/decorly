...
const stepsData: Step[] = [
  {
    ...
    description:
      'Lorem ipsum dolor consectetur adipiscing elit, sed do eiusmod temporary incididunt ut labor et, nullam sit amet magna sit amet risus accum san sagittis id vitae.',
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="mt-6 text-lg text-gray-500">
            Lorem ipsum dolor consectetur adipiscing elit, sed do eiusmod temporary incididunt ut
          </p>
        </div>
